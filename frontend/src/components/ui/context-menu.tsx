 ...
 * ========================================
 * 
 * Purpose: Right-click context menu with submenus and various item types
 * 
 * Description:
 * This is a context menu component from shadcn/ui that provides a right-click
 * context menu interface with submenus, checkbox items, radio items, and
 * separators. It's built on Radix UI primitives for accessibility and proper
 * context menu behavior, supporting complex menu hierarchies and various
 ...
 * - ContextMenuTrigger: Context menu trigger area
 ...
 * - ContextMenuPortal: Portal for menu positioning
 ...
 * 
 * Dependencies:
 * - Radix UI Context Menu primitives
