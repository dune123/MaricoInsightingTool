 ...
 * ========================================
 * 
 * Purpose: Slide-out panel component for mobile-first interfaces
 * 
 * Description:
 * This is a comprehensive sheet component system from shadcn/ui that
 * provides slide-out panels from different screen edges. It's built
 * on Radix UI Dialog primitives and designed for mobile-first
 * interfaces with smooth animations and proper accessibility.
 * 
 * Key Features:
 * - Slide-out panels from four screen edges
 ...
 * 
 * Components:
 * - Sheet: Root component for sheet state
 * - SheetTrigger: Element that opens the sheet
 * - SheetPortal: Portal for proper rendering
 * - SheetOverlay: Backdrop overlay
 * - SheetContent: Main sheet container
 ...
 * - Smooth slide animations
 * - Responsive sizing (3/4 width/height)
 * - Backdrop with fade effects
