 ...
 * ========================================
 * 
 * Purpose: Dropdown menu with submenus, checkboxes, and radio items
 * 
 * Description:
 * This is a dropdown menu component from shadcn/ui that provides a dropdown
 * menu interface with submenus, checkbox items, radio items, and separators.
 * It's built on Radix UI primitives for accessibility and proper dropdown
 * behavior, supporting complex menu hierarchies and various interactive
 * item types with smooth animations.
 * 
 * Key Features:
 ...
 * 
 * Components:
 * - DropdownMenu: Main dropdown menu container
 ...
 * - DropdownMenuPortal: Portal for menu positioning
