 ...
 * ========================================
 * 
 * Purpose: Dropdown selection component with comprehensive functionality
 * 
 * Description:
 * This is a complete select component system from shadcn/ui that provides
 * dropdown selection functionality with search, scrolling, grouping, and
 * accessibility features. It's built on Radix UI primitives for robust
 * behavior and keyboard navigation.
 * 
 * Key Features:
 * - Dropdown selection with search and filtering
 * - Scrollable content with up/down buttons
 * - Group support for organized options
 * - Keyboard navigation and accessibility
 * - Customizable trigger and content styling
 * - Portal rendering for proper layering
 * 
 * Components:
 * - Select: Root component for selection state
 ...
 * - SelectLabel: Group label for organization
