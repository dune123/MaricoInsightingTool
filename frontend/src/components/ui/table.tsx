 ...
 * ========================================
 * 
 * Purpose: Comprehensive table component system for data display
 * 
 * Description:
 * This is a complete table component system from shadcn/ui that provides
 * all necessary table elements with consistent styling and responsive
 * behavior for displaying structured data.
 * 
 * Key Features:
 * - Complete table element set (Table, Header, Body, Row, Cell, etc.)
 * - Responsive design with automatic horizontal scrolling
 * - Consistent styling with proper spacing and borders
 * - Caption support for accessibility
 * - Footer support for summaries and totals
 * 
 * Components:
 * - Table: Main table container with overflow handling
 * - TableHeader: Header section with styling
 * - TableBody: Main content area
 * - TableFooter: Footer for summaries
