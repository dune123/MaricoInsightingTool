 ...
 * ========================================
 * 
 * Purpose: Accessible navigation menu with dropdown content and viewport
 * 
 * Description:
 * This is a navigation menu component from shadcn/ui that provides an
 * accessible navigation interface with dropdown content, viewport
 * management, and smooth animations. It's built on Radix UI primitives
 * for accessibility and proper navigation behavior, supporting complex
 * navigation hierarchies with content previews.
 * 
 * Key Features:
 * - Accessible navigation menu
 * - Dropdown content with viewport
 ...
 * 
 * Components:
 * - NavigationMenu: Main navigation container
 ...
 * - NavigationMenuIndicator: Navigation indicator
 * 
 * Navigation Features:
 ...
 * 
 * Dependencies:
 * - Radix UI Navigation Menu primitives
